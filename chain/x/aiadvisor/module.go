...
// AppModule implements the Cosmos SDK module interface for the AI advisor.
...
func (am AppModule) RegisterServices(cfg module.Configurator) {
	aiadvisorv1.RegisterQueryServer(cfg.QueryServer(), NewQueryServer(am.keeper))
}

// EndBlock persists the advisor's streak and proposal counter state.
